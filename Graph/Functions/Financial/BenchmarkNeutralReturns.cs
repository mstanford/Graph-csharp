...
{
	public class BenchmarkNeutralReturns : Function
	{

		public override double[] Evaluate2(double[] X1, double[] X2)
		{
			return new BenchmarkNeutralReturns2(1.0, -1.0).Evaluate2(X1, X2);
		}

		//public override void EvaluateQuery2(Dictionary<string, object> STATE, string hiveName, string x1, string x2, string y)
		//{
		//    new BenchmarkNeutralReturns2(1.0, -1.0).EvaluateQuery2(STATE, hiveName, x1, x2, y);
		//}
