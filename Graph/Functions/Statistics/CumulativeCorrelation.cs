...
{
	public class CumulativeCorrelation : Function
	{
		private CumulativeCovariance _covxy;
		private CumulativeStandardDeviation _sigma_x;
		private CumulativeStandardDeviation _sigma_y;

		public CumulativeCorrelation()
		{
			_covxy = new CumulativeCovariance();
			_sigma_x = new CumulativeStandardDeviation();
			_sigma_y = new CumulativeStandardDeviation();
