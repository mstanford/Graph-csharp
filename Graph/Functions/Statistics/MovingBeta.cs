...
{
	public class MovingBeta : Function
	{
		private readonly MovingCovariance _covariance_stock_market;
		private readonly MovingVariance _sigma2_market;

		// Beta = Corr * (Sigma(a) / Sigma(b))
		// Beta = Cov(a, b) / Var(b)

		public MovingBeta(int n)
		{
			_covariance_stock_market = new MovingCovariance(n);
			_sigma2_market = new MovingVariance(n);
		}
