...
{
	public class GridCell : Widget
	{
		public readonly System.Drawing.Rectangle GridCoordinates;

		public GridCell(int gridX, int gridY, int gridWidth, int gridHeight, Widget widget)
			: base(widget)
		{
			GridCoordinates = new System.Drawing.Rectangle(gridX, gridY, gridWidth, gridHeight);
		}
