...
namespace Graph.Widgets
{
	public class Label : Widget
	{
		...
		public override void Initialize(Scripting.Frame frame, Style style)
		{
			...
			{
				_value = (string)Scripting.Convert.ChangeType(Frame.Values[Name], typeof(string));
				size = Style.Graphics.MeasureString(_value, Style.Font);
			}
			else
			{
				size = Style.Graphics.MeasureString("#", Style.Font);
			}
		...
		{
			graphics.DrawString(_value, Style.Font, Style.ForeBrush, rectangle.X + LEFT_MARGIN, rectangle.Y + TOP_MARGIN);
