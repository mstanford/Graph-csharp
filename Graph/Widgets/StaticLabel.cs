...
{
	public class StaticLabel : Widget
	{
        ...
        public StaticLabel(string name)
			: base(name)
		{
		...
		public override void Initialize(Scripting.Frame frame, Style style)
		{
			...
			System.Drawing.SizeF size = Style.Graphics.MeasureString(Name, Style.Font);
		...
		{
            graphics.DrawString(Name, Style.Font, Style.ForeBrush, rectangle.X + LEFT_MARGIN, rectangle.Y + TOP_MARGIN);
