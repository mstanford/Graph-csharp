...
namespace Graph.Widgets
{
	public class Title : Widget
	{
		...
		public override void Initialize(Scripting.Frame frame, Style style)
		{
			...
			System.Drawing.SizeF size = Style.Graphics.MeasureString(_title, Style.TitleFont);
		...
		public override void Render(System.Drawing.Graphics graphics, System.Drawing.RectangleF rectangle)
		{
			...
			graphics.DrawString(_title, Style.TitleFont, Style.TitleBrush, new System.Drawing.RectangleF(rectangle.X + LEFT_MARGIN, rectangle.Y + TOP_MARGIN, rectangle.Width - LEFT_MARGIN - RIGHT_MARGIN, Style.TitleFont.Height), stringFormat);
